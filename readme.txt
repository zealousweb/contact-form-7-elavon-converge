...
= 3.0 =
* Fix - Compatibility with latest Contact Form 7.
* Fix - Solved Tooltip issue with WordPress Latest version 5.5

= 2.2 =
* Fix - Solved Form ID get method changes according to New Contact form Version
* Add - Add Tooltip with all option for more help in settings

= 2.1 =
* Fix - Solved Payment issue with Latest Contact Form 7
